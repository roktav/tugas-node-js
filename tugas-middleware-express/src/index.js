...
function init() {
    ...
    app.post("/single", upload_middleware_1.single, (req, res) => __awaiter(this, void 0, void 0, function* () {
        if (!req.file) {
    ...
    app.post("/multiple", upload_middleware_1.multiple, (req, res) => __awaiter(this, void 0, void 0, function* () {
